...
"Packagist":https://packagist.org/packages/rah/rah_swap | "Issues":https://github.com/gocom/rah_swap | "Donate":https://rahforum.biz/donate/rah_swap
...
Example: @link="template_db"@ Default: _unset_
...
The contents wrapped in the @<rah::_swap>@ tags will be pulled from database named as **promotional_content_db**.
